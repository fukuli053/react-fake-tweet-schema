...
export default function Tweet({config}) {
        ...
        return (
            <div className="user-info">
                <div className="profile-photo-container">
                    <img className="profile-photo" src={config.user.avatar} alt={config.user.name + " avatar"}/>
                </div>
    ...
    function Metadata() {
        return (
            <div className="metadata">
                {config.date} · <span className="link app">{config.app}</span>
            </div>
        );
    }
            ...
            <div className="action-buttons">
                {
                    actions.map((action, key) =>
                        <div key={key} className={`action-button ${action.color}`}>
                            <div>
                                {action.icon}
                            </div>
                        </div>
